...
def mixup_collate(batch):
    ...
    Expects batch: list of tuples (image, (targets, masks, num_crowds))
    """
    # Импорт реализации MixUp
    from utils.mixup import mixup_batch
    
    # Вызовм функции, которая смешивает изображения и объединяет цели
    images, targets, masks, num_crowds = mixup_batch(batch)
